            ...
            for (NSString *key in [sets allKeys]) {
                ...
                if ([hardware isEqualToString:@"AirPort"] || [hardware isEqualToString:@"Wi-Fi"] || [hardware isEqualToString:@"Ethernet"]) {
                    ...
                    if ([mode isEqualToString:@"auto"]) {
                        ...
                        NSString *pacUrl = [NSString stringWithFormat:@"%@?ts=%f", @"http://127.0.0.1:6311/proxy.pac", timestamp];
                        ...
                        [proxies setObject:[NSNumber numberWithInteger:2080] forKey:(NSString*)
