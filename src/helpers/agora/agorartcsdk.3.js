    ...
    return function (e) {
        ...
        var p = function () {
                ...
                h = function (e, t) {
                    if (l) try {
                        ...
                        t.forEach(function (e) {
                            "object" === (void 0 === e ? "undefined" : n(e)) && (e = JSON.stringify(e)), i = i + e + " "
                        });
                        var r = {
                            payload: i,
                            log_level: e
            ...
            return t = function () {
                ...
                if (!(e < _)) switch (e) {
                    case 0:
                        t[0] = (0, r.getTimestamp)() + " Agora-SDK [DEBUG]:", h("DEBUG", t), console.log.apply(console, t);
                        break;
                    case 1:
                        t[0] = (0, r.getTimestamp)() + " Agora-SDK [INFO]:", h("INFO", t), console.log.apply(console, t);
                        break;
                    case 2:
                        t[0] = (0, r.getTimestamp)() + " Agora-SDK [WARN]:", h("WARN", t), console.warn.apply(console, t);
                        break;
                    case 3:
                        t[0] = (0, r.getTimestamp)() + " Agora-SDK [ERROR]:", h("ERROR", t), console.error.apply(console, t);
                        break;
                    default:
                        return t[0] = (0, r.getTimestamp)() + " Agora-SDK [DEFAULT]:", h("DEFAULT", t), void console.log.apply(console, t)
                }
            }, i = function () {
        ...
        var r = i(1),
            ...
            p = null,
            f = function () {
                return p || (p = "process-" + (0, u.default)(), s.default.info("processId: " + p)), p
            },
            m = function () {
                var e = {};
                return e.list = {}, e.url = (0, d.shouldUseHttps)() ? "https://" + o.EVENT_REPORT_DOMAIN + ":6443/events/report" : "http://" + o.EVENT_REPORT_DOMAIN + ":6080/events/report", e.urlBackup = (0, d.shouldUseHttps)() ? "https://" + o.EVENT_REPORT_BACKUP_DOMAIN + ":6443/events/report" : "http://" + o.EVENT_REPORT_BACKUP_DOMAIN + ":6080/events/report", e.setProxyServer = function (t) {
                    t && (e.url = (0, d.shouldUseHttps)() ? "https://" + t + "/rs/?h=" + o.EVENT_REPORT_DOMAIN + "&p=6443&d=events/report" : "http://" + t + "/rs/?h=" + o.EVENT_REPORT_DOMAIN + "&p=6080&d=events/report", e.urlBackup = (0, d.shouldUseHttps)() ? "https://" + t + "/rs/?h=" + o.EVENT_REPORT_BACKUP_DOMAIN + "&p=6443&d=events/report" : "http://" + t + "/rs/?h=" + o.EVENT_REPORT_BACKUP_DOMAIN + "&p=6080&d=events/report", s.default.debug("reportProxyServerURL: " + e.url), s.default.debug("reportProxyServerBackupURL: " + e.urlBackup))
                    ...
                    delete r.appid, delete r.mode, e.list[t] = r, a.extend = null, a.ver = o.VERSION, a.type = "session_init", a.browser = navigator.userAgent, a.lts = +new Date, a.elaps = a.lts - a.startTime, a.process = f(), e.send(a)
                }, e.joinChooseServer = function (t, i, n) {
                    var r;
                    r = n ? Object.assign(e.list[t], i) : Object.assign({}, e.list[t], i), r.type = "join_choose_server";
                    var o = +new Date;
                    ...
                    n.type = "join_gateway";
                    var r = +new Date;
                    n.ev_elaps = r - n.lts, n.elaps = r - n.startTime, n.lts = r, e.send(n)
                    ...
                    var n = Object.assign({}, e.list[t], i);
                    n.type = "first_remote_frame", n.lts = +new Date, n.elaps = n.lts - n.startTime, e.send(n)
                }, e.streamSwitch = function (t, i) {
                    var n = Object.assign({}, e.list[t], i);
                    n.type = "stream_switch", n.isdual = i.isdual, n.lts = +new Date, n.elaps = n.lts - n.startTime, e.send(n)
                }, e.audioSendingStopped = function (t, i) {
                    var n = Object.assign({}, e.list[t], i);
                    n.type = "audio_sending_stopped", n.lts = +new Date, n.elaps = n.lts - n.startTime, e.send(n)
                }, e.videoSendingStopped = function (t, i) {
                    var n = Object.assign({}, e.list[t], i);
                    n.type = "video_sending_stopped", n.lts = +new Date, n.elaps = n.lts - n.startTime, e.send(n)
                }, e.send = function (t) {
                    try {
                        (0, d.post)(e.url, t, null, function (i) {
                            (0, d.post)(e.urlBackup, t, null, function (e) {}, {
                                timeout: 1e4
                            })
                        }, {
                            timeout: 1e4
        ...
        t.report = m, t.SESSION_INIT = "session_init", t.JOIN_CHOOSE_SERVER = "join_choose_server", t.JOIN_GATEWAY = "join_gateway", t.PUBLISH = "publish", t.SUBSCRIBE = "subscribe", t.getProcessId = f
    }, function (e, t, i) {
        "use strict";
        ...
        if ("object" == ("undefined" == typeof window ? "undefined" : r(window)) ? (!window.HTMLMediaElement || "srcObject" in window.HTMLMediaElement.prototype ? (p = function (e, t) {
            ...
            if (navigator.mozGetUserMedia && window.mozRTCPeerConnection) {
                v.log("This appears to be Firefox"), d = "firefox", c = v.extractVersion(navigator.userAgent, /Firefox\/([0-9]+)\./, 1), u = 31, m = mozRTCPeerConnection;
                ...
                if (l = function (e, t) {
                            ...
                            for (var i = [], n = 0; n < e.iceServers.length; n++) {
                                ...
                                if (r.hasOwnProperty("urls"))
                                    for (var o = 0; o < r.urls.length; o++) {
                                        ...
                                        0 === r.urls[o].indexOf("turn") && (a.username = r.username, a.credential = r.credential), i.push(a)
                        ...
                        return c < 38 && (v.log("spec: " + JSON.stringify(e)), e.audio && (e.audio = n(e.audio)), e.video && (e.video = n(e.video)), v.log("ff37: " + JSON.stringify(e))), navigator.mozGetUserMedia(e, t, i)
            ...
            v.log("This appears to be Chrome"), d = "chrome", c = v.extractVersion(navigator.userAgent, /Chrom(e|ium)\/([0-9]+)\./, 2), u = 38, m = webkitRTCPeerConnection;
            for (var _ in g) g[_] = m.prototype[_];
            l = function (e, t) {
                ...
                return Object.keys(e).forEach(function (i) {
                    if ("require" !== i && "advanced" !== i && "mediaSource" !== i) {
                        ...
                        if (void 0 !== n.ideal) {
                            ...
                            var a = {};
                            "number" == typeof n.ideal ? (a[o("min", i)] = n.ideal, t.optional.push(a), a = {}, a[o("max", i)] = n.ideal, t.optional.push(a)) : (a[o("", i)] = n.ideal, t.optional.push(a))
                        }
            ...
            if (o = function (e, t, i) {
                    return e.audio && (e.audio = E(e.audio)), e.video && (e.video = E(e.video)), v.log("chrome: " + JSON.stringify(e)), navigator.webkitGetUserMedia(e, t, i)
                }, navigator.getUserMedia = o, navigator.mediaDevices || (navigator.mediaDevices = {
                    getUserMedia: n,
                ...
                navigator.mediaDevices.getUserMedia = function (e) {
                    return v.log("spec:   " + JSON.stringify(e)), e.audio = E(e.audio), e.video = E(e.video), v.log("chrome: " + JSON.stringify(e)), h(e)
                }
        ...
        var R;
        l ? R = l : "undefined" != typeof window && (R = window.RTCPeerConnection), e.exports = {
            RTCPeerConnection: R,
            getUserMedia: o,
            attachMediaStream: a,
        ...
        t.EventDispatcher = n, t.StreamEvent = o, t.ClientEvent = a, t.MediaEvent = s, t.LiveStreamingEvent = d
    }, function (e, t, i) {
        "use strict";
        ...
        t.default = o, t.APErrorCode = a, t.GatewayErrorCode = s, t.JOIN_GS_TRYNEXT_LIST = d, t.JOIN_CS_RETRY_LIST = c
    }, function (e, t, i) {
        "use strict";
        Object.defineProperty(t, "__esModule", {
            value: !0
        ...
        t.getBrowserInfo = v, t.getBrowserVersion = l, t.getBrowserOS = p, t.isChrome = n, t.isSafari = r, t.isFireFox = o, t.isOpera = a, t.isQQBrowser = s, t.isWeChatBrowser = d, t.isSupportedPC = c, t.isSupportedMobile = u, t.getChromeKernelVersion = m, t.isChromeKernel = f
    }, function (e, t, i) {
        "use strict";
        ...
        var o = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
            ...
            E = function (e) {
                ...
                for (var i in e)
                    if ("lowLatency" === i && "boolean" != typeof e[i] || "userConfigExtraInfo" === i && "object" !== o(e[i]) || "transcodingUsers" === i && !h(e[i]) || !~t.indexOf(i) && "number" != typeof e[i]) throw new Error("Param [" + i + "] is inVaild");
                return !0
            },
            h = function (e) {
                for (var t = 0; t < e.length; t++)
                    for (var i in e[t])
                        if ("number" != typeof e[t][i]) throw new Error("Param user[" + t + "] - [" + i + "] is inVaild");
                return !0
            },
            I = function (e) {
                isNaN(e) && (e = 1e3);
            ...
            R = function () {
                if (!document.getElementById("agora-ban-tip")) {
                    ...
                    r.innerText = "This browser does not support webRTC", i.append(n), i.append(r);
                    var o = document.createElement("div");
                    o.style = "height: 38px; display: flex; border-top: #fff 1px solid; justify-content: center; align-items: center;", o.innerText = "OK", t.append(i), t.append(o), o.onclick = function () {
                        var e = document.getElementById("agora-ban-tip");
                        e.parentNode.removeChild(e)
                    }
                }
            };
        t.checkSystemRequirements = m, t.isLiveTranscodingValid = E, t.generateSessionId = r, t.audioLevelHelper = v, t.vsResHack = _, t.is32Uint = S, t.safeCall = g, t.random = I, t.popBanTip = R
    }, function (e, t, i) {
        "use strict";
        Object.defineProperty(t, "__esModule", {
            value: !0
        ...
        var n = i(1),
            ...
            o = function (e, t, i, n, o) {
                ...
                if (a.timeout = t.timeout || r.HTTP_CONNECT_TIMEOUT, a.open("POST", e, !0), a.setRequestHeader("Content-type", "application/json; charset=utf-8"), o)
                    for (var s in o) "withCredentials" == s ? a.withCredentials = !0 : a.setRequestHeader(s, o[s]);
                a.onload = function (e) {
                    i && i(a.responseText)
        ...
        var r = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
            ...
            _ = function (e) {
                ...
                if (o.params = Object.assign({}, e), o.stream = e.stream, o.url = e.url, o.onClose = void 0, o.local = !1, o.videoSource = e.videoSource, o.audioSource = e.audioSource, o.video = !!e.video, o.audio = !!e.audio, o.screen = !!e.screen, o.screenAttributes = {
                        width: 1920,
                        height: 1080,
                        maxFr: 5,
                        minFr: 1
                    }, o.videoSize = e.videoSize, o.player = void 0, o.audioLevelHelper = null, e.attributes = e.attributes || {}, o.attributes = e.attributes, o.videoEnabled = !0, o.audioEnabled = !0, o.lowStream = null, o.videoWidth = 0, o.videoHeight = 0, o.streamId = null, o.streamId = e.streamID, o.userId = null, o.mirror = !1 !== e.mirror, o.DTX = e.audioProcessing && e.audioProcessing.DTX, o.audioProcessing = e.audioProcessing, o.highQuality = !1, o.stereo = !1, o.speech = !1, !(void 0 === o.videoSize || o.videoSize instanceof Array && 4 === o.videoSize.length)) throw Error("Invalid Video Size");
                o.videoSize = [640, 480, 640, 480], void 0 !== e.local && !0 !== e.local || (o.local = !0), o.initialized = !o.local, o.on("collectStats", function (e) {
                    e.promises.push(o._getPCStats()), e.promises.push(new Promise(function (e) {
                        var t = {};
                        o.pc && o.pc.isSubscriber ? i() && ((0, p.setStat)(t, "videoReceiveResolutionHeight", o.videoHeight), (0, p.setStat)(t, "videoReceiveResolutionWidth", o.videoWidth)) : o.pc && !o.pc.isSubscriber && (((0, l.isSafari)() || (0, l.isFireFox)()) && ((0, p.setStat)(t, "videoSendResolutionHeight", o.videoHeight), (0, p.setStat)(t, "videoSendResolutionWidth", o.videoWidth)), ((0, l.isSafari)() || (0, l.isFireFox)()) && o.uplinkStats && (0, p.setStat)(t, "videoSendPacketsLost", o.uplinkStats.uplink_cumulative_lost)), e(t)
                ...
                return o.unmuteAudio = void 0, o.muteAudio = void 0, o.unmuteVideo = void 0, o.muteVideo = void 0, o.setVideoResolution = function (t) {
                    return t += "", void 0 !== c[t] && (e.video = c[t], e.attributes = e.attributes || {}, e.attributes.resolution = t, !0)
                    ...
                    if ("string" == typeof e && o.screen) {
                        switch (e) {
                            case "480p_1":
                                o.screenAttributes.width = 640, o.screenAttributes.height = 480, o.screenAttributes.maxFr = 5, o.screenAttributes.minFr = 1;
                                break;
                            case "480p_2":
                                o.screenAttributes.width = 640, o.screenAttributes.height = 480, o.screenAttributes.maxFr = 30, o.screenAttributes.minFr = 25;
                                break;
                            case "720p_1":
                                o.screenAttributes.width = 1280, o.screenAttributes.height = 720, o.screenAttributes.maxFr = 5, o.screenAttributes.minFr = 1;
                                break;
                            case "720p_2":
                                r.screenAttributes.width = 1280, r.screenAttributes.height = 720, r.screenAttributes.maxFr = 15, r.screenAttributes.minFr = 5;
                                break;
                            case "1080p_1":
                                /**
                                 * maxFr 原本为5比较卡顿， 调优后改为10
                                 * @time 2018/8/29
                                 * @author gaolong/shijh
                                 */
                                o.screenAttributes.width = 1920, o.screenAttributes.height = 1080, o.screenAttributes.maxFr = 10, o.screenAttributes.minFr = 1;
                                break;
                            case "1080p_2":
                                o.screenAttributes.width = 1920, o.screenAttributes.height = 1080, o.screenAttributes.maxFr = 30, o.screenAttributes.minFr = 25
                        }
                        return !0
                    }
                    return !1
                }, o.setVideoProfileCustom = function (e) {
                    o.setVideoResolution(e[0]), o.setVideoFrameRate([e[1], e[1]]), o.setVideoBitRate([e[2], e[2]])
                }, o.setVideoProfileCustomPlus = function (t) {
                    console.log(t), e.video = n(t.width, t.height), e.attributes = e.attributes || {}, e.attributes.resolution = t.width + "x" + t.height, o.setVideoFrameRate([t.framerate, t.framerate]), o.setVideoBitRate([t.bitrate, t.bitrate])
                    ...
                    if (o.profile = e, "string" == typeof e && o.video) {
                        switch (e) {
                            ...
                            case "120p_1":
                            case "120P_1":
                                o.setVideoResolution("120p_1"), o.setVideoFrameRate([15, 15]), o.setVideoBitRate([10, 65]);
                                break;
                            case "120p_3":
                            case "120P_3":
                                o.setVideoResolution("120p_3"), o.setVideoFrameRate([15, 15]), o.setVideoBitRate([10, 50]);
                                break;
                            case "180p":
                            case "180P":
                            case "180p_1":
                            case "180P_1":
                                o.setVideoResolution("180p_1"), o.setVideoFrameRate([15, 15]), o.setVideoBitRate([10, 140]);
                                break;
                            case "180p_3":
                            case "180P_3":
                                o.setVideoResolution("180p_3"), o.setVideoFrameRate([15, 15]), o.setVideoBitRate([10, 100]);
                                break;
                            case "180p_4":
                            case "180P_4":
                                o.setVideoResolution("180p_4"), o.setVideoFrameRate([15, 15]), o.setVideoBitRate([10, 120]);
                                break;
                            case "240p":
                            case "240P":
                            case "240p_1":
                            case "240P_1":
                                o.setVideoResolution("240p_1"), o.setVideoFrameRate([15, 15]), o.setVideoBitRate([10, 200]);
                                break;
                            case "240p_3":
                            case "240P_3":
                                o.setVideoResolution("240p_3"), o.setVideoFrameRate([15, 15]), o.setVideoBitRate([10, 140]);
                                break;
                            case "240p_4":
                            case "240P_4":
                                o.setVideoResolution("240p_4"), o.setVideoFrameRate([15, 15]), o.setVideoBitRate([10, 220]);
                                break;
                            case "360p":
                            case "360P":
                            case "360p_1":
                            case "360P_1":
                                o.setVideoResolution("360p_1"), o.setVideoFrameRate([15, 15]), o.setVideoBitRate([20, 400]);
                                break;
                            case "360p_3":
                            case "360P_3":
                                o.setVideoResolution("360p_3"), o.setVideoFrameRate([15, 15]), o.setVideoBitRate([20, 260]);
                                break;
                            case "360p_4":
                            case "360P_4":
                                o.setVideoResolution("360p_4"), o.setVideoFrameRate([30, 30]), o.setVideoBitRate([20, 600]);
                                break;
                            case "360p_6":
                            case "360P_6":
                                o.setVideoResolution("360p_6"), o.setVideoFrameRate([30, 30]), o.setVideoBitRate([20, 400]);
                                break;
                            case "360p_7":
                            case "360P_7":
                                o.setVideoResolution("360p_7"), o.setVideoFrameRate([15, 15]), o.setVideoBitRate([20, 320]);
                                break;
                            case "360p_8":
                            case "360P_8":
                                o.setVideoResolution("360p_8"), o.setVideoFrameRate([30, 30]), o.setVideoBitRate([20, 490]);
                                break;
                            case "360p_9":
                            case "360P_9":
                                o.setVideoResolution("360p_9"), o.setVideoFrameRate([15, 15]), o.setVideoBitRate([20, 800]);
                                break;
                            case "360p_10":
                            case "360P_10":
                                o.setVideoResolution("360p_10"), o.setVideoFrameRate([24, 24]), o.setVideoBitRate([20, 800]);
                                break;
                            case "360p_11":
                            case "360P_11":
                                o.setVideoResolution("360p_11"), o.setVideoFrameRate([24, 24]), o.setVideoBitRate([20, 1e3]);
                                break;
                            case "480p":
                            case "480P":
                            case "480p_1":
                            case "480P_1":
                                o.setVideoResolution("480p_1"), o.setVideoFrameRate([15, 15]), o.setVideoBitRate([20, 500]);
                                break;
                            case "480p_2":
                            case "480P_2":
                                o.setVideoResolution("480p_2"), o.setVideoFrameRate([30, 30]), o.setVideoBitRate([20, 1e3]);
                                break;
                            case "480p_3":
                            case "480P_3":
                                o.setVideoResolution("480p_3"), o.setVideoFrameRate([15, 15]), o.setVideoBitRate([20, 400]);
                                break;
                            case "480p_4":
                            case "480P_4":
                                o.setVideoResolution("480p_4"), o.setVideoFrameRate([30, 30]), o.setVideoBitRate([20, 750]);
                                break;
                            case "480p_6":
                            case "480P_6":
                                o.setVideoResolution("480p_6"), o.setVideoFrameRate([30, 30]), o.setVideoBitRate([20, 600]);
                                break;
                            case "480p_8":
                            case "480P_8":
                                o.setVideoResolution("480p_8"), o.setVideoFrameRate([15, 15]), o.setVideoBitRate([20, 610]);
                                break;
                            case "480p_9":
                            case "480P_9":
                                o.setVideoResolution("480p_9"), o.setVideoFrameRate([30, 30]), o.setVideoBitRate([20, 930]);
                                break;
                            case "480p_10":
                            case "480P_10":
                                o.setVideoResolution("480p_10"), o.setVideoFrameRate([10, 10]), o.setVideoBitRate([20, 400]);
                                break;
                            case "720p":
                            case "720P":
                            case "720p_1":
                            case "720P_1":
                                o.setVideoResolution("720p_1"), o.setVideoFrameRate([15, 15]), o.setVideoBitRate([30, 1130]);
                                break;
                            case "720p_2":
                            case "720P_2":
                                o.setVideoResolution("720p_2"), o.setVideoFrameRate([30, 30]), o.setVideoBitRate([30, 2e3]);
                                break;
                            case "720p_3":
                            case "720P_3":
                                o.setVideoResolution("720p_3"), o.setVideoFrameRate([30, 30]), o.setVideoBitRate([30, 1710]);
                                break;
                            case "720p_5":
                            case "720P_5":
                                o.setVideoResolution("720p_5"), o.setVideoFrameRate([15, 15]), o.setVideoBitRate([30, 910]);
                                break;
                            case "720p_6":
                            case "720P_6":
                                o.setVideoResolution("720p_6"), o.setVideoFrameRate([30, 30]), o.setVideoBitRate([30, 1380]);
                                break;
                            case "1080p":
                            case "1080P":
                            case "1080p_1":
                            case "1080P_1":
                                o.setVideoResolution("1080p_1"), o.setVideoFrameRate([15, 15]), o.setVideoBitRate([50, 2080]);
                                break;
                            case "1080p_2":
                            case "1080P_2":
                                o.setVideoResolution("1080p_2"), o.setVideoFrameRate([30, 30]), o.setVideoBitRate([50, 3e3]);
                                break;
                            case "1080p_3":
                            case "1080P_3":
                                o.setVideoResolution("1080p_3"), o.setVideoFrameRate([30, 30]), o.setVideoBitRate([50, 3150]);
                                break;
                            case "1080p_5":
                            case "1080P_5":
                                o.setVideoResolution("1080p_5"), o.setVideoFrameRate([60, 60]), o.setVideoBitRate([50, 4780]);
                                break;
                            case "1440p":
                            case "1440P":
                            case "1440p_1":
                            case "1440P_1":
                                o.setVideoResolution("1440p_1"), o.setVideoFrameRate([30, 30]), o.setVideoBitRate([50, 4850]);
                                break;
                            case "1440p_2":
                            case "1440P_2":
                                o.setVideoResolution("1440p_2"), o.setVideoFrameRate([60, 60]), o.setVideoBitRate([50, 7350]);
                                break;
                            case "4k":
                            case "4K":
                            case "4k_1":
                            case "4K_1":
                                o.setVideoResolution("4k_1"), o.setVideoFrameRate([30, 30]), o.setVideoBitRate([50, 8910]);
                                break;
                            case "4k_3":
                            case "4K_3":
                                o.setVideoResolution("4k_3"), o.setVideoFrameRate([60, 60]), o.setVideoBitRate([50, 13500]);
                                break;
                            default:
                                o.setVideoResolution("480p_1"), o.setVideoFrameRate([15, 15]), o.setVideoBitRate([20, 500])
                        }
                    ...
                    if (o.audioProfile = e, "string" == typeof e && o.audio) {
                        switch (e) {
                            case "speech_standard":
                                o.highQuality = !1, o.stereo = !1, o.speech = !0;
                                break;
                            case "music_standard":
                                o.highQuality = !1, o.stereo = !1, o.speech = !1;
                                break;
                            case "standard_stereo":
                                o.highQuality = !1, o.stereo = !0, o.speech = !1;
                                break;
                            case "high_quality":
                                o.highQuality = !0, o.stereo = !1, o.speech = !1;
                                break;
                            case "high_quality_stereo":
                                o.highQuality = !0, o.stereo = !0, o.speech = !1;
                                break;
                            default:
                                o.highQuality = !1, o.stereo = !1, o.speech = !1
                        }
                    ...
                    o.userId && u.default.warning("Stream.userId " + o.userId + " => " + e), o.userId = e
                    ...
                    if (o.videoSource || o.audioSource) {
                        ...
                        return o.videoSource && (u.default.debug("Added videoSource"), d.addTrack(o.videoSource), o.video = !0), o.audioSource && (u.default.debug("Added audioSource"), d.addTrack(o.audioSource), o.audio = !0), o.hasVideo() ? (0, f.vsResHack)(d, function (e, t) {
                            u.default.info("Video Source width " + e + " height " + t), o.stream = d, o.initialized = !0, i && i()
                        }, function (e) {
                            u.default.warning("Failed to get width & height from video source", e), o.stream = d, o.initialized = !0, i && i()
                    ...
                    try {
                        if ((e.audio || e.video || e.screen) && void 0 === e.url) {
                            ...
                            u.default.debug(p);
                            var _ = Object.assign({}, p);
                            if ((0, s.GetUserMedia)(_, function (t) {
                                    o.screenAudioTrack && t.addTrack(o.screenAudioTrack);
                                    var r = t.getVideoTracks().length > 0,
                                        a = t.getAudioTracks().length > 0;
                                    return _.video && !r && _.audio && !a ? (u.default.error("Media access: NO_CAMERA_MIC_PERMISSION"), n && n("NO_CAMERA_MIC_PERMISSION")) : _.video && !r ? (u.default.error("Media access: NO_CAMERA_PERMISSION"), n && n("NO_CAMERA_PERMISSION")) : _.screen && !r ? (u.default.error("Media access: NO_SCREEN_PERMISSION"), n && n("NO_SCREEN_PERMISSION")) : _.audio && !a ? (u.default.error("Media access: NO_MIC_PERMISSION"), n && n("NO_MIC_PERMISSION")) : (u.default.debug("User has granted access to local media"), o.dispatchEvent({
                                        type: "accessAllowed"
                                    }), o.stream = t, o.initialized = !0, e.screen && e.audio && !o.screenAudioTrack || i && i(), o.hasVideo() && (0, f.vsResHack)(t, function (e, t) {
                                        o.videoWidth = e, o.videoHeight = t
                                    }, function (e) {
                                    ...
                                    switch (t.msg) {
                                        ...
                                        case "PermissionDeniedError":
                                            t.msg = "PERMISSION_DENIED", o.dispatchEvent({
                                                type: "accessDenied"
                                            });
                                            break;
                                    ...
                                    u.default.error("Media access:", t.msg), "function" == typeof n && n(t)
                                }), e.screen && e.audio) {
                                var S = !e.microphoneId || {
                                    ...
                                    v = {};
                                o.audioProcessing && (void 0 !== o.audioProcessing.AGC && ((0, l.isFireFox)() ? v.autoGainControl = o.audioProcessing.AGC : (0, l.isChrome)() && (v.googAutoGainControl = o.audioProcessing.AGC, v.googAutoGainControl2 = o.audioProcessing.AGC)), void 0 !== o.audioProcessing.AEC && (v.echoCancellation = o.audioProcessing.AEC), void 0 !== o.audioProcessing.ANS && ((0, l.isFireFox)() ? v.noiseSuppression = o.audioProcessing.ANS : (0, l.isChrome)() && (v.googNoiseSuppression = o.audioProcessing.ANS))), o.stereo && (0, l.isChrome)() && (v.googAutoGainControl = !1, v.googAutoGainControl2 = !1, v.echoCancellation = !1, v.googNoiseSuppression = !1), 0 !== Object.keys(v).length && (S = !0 === S ? {
                                    mandatory: v
                                } : Object.assign(S, v));
                                var E = {
                                    video: !1,
                                ...
                                u.default.debug(E), (0, s.GetUserMedia)(E, function (e) {
                                    u.default.info("User has granted access to auxiliary local media."), o.dispatchEvent({
                                        type: "accessAllowed"
                                    });
                        ...
                        u.default.error("Stream init:", e), "function" == typeof n && n({
                            type: "error",
                            msg: e.message || e
                        })
                    }
                }, o.close = function () {
                    if (u.default.debug("Close stream with id", o.streamId), void 0 !== o.stream) {
                        var e = o.stream.getTracks();
                        for (var t in e) e.hasOwnProperty(t) && e[t].stop();
                        o.stream = void 0
                    }
                    o.initialized = !1, o.unmuteAudio = void 0, o.muteAudio = void 0, o.unmuteVideo = void 0, o.muteVideo = void 0, o.lowStream && o.lowStream.close()
                }, o.enableAudio = function () {
                    return u.default.debug("Enable audio stream with id", o.streamId), !(!o.hasAudio() || !o.initialized || void 0 === o.stream || !0 === o.stream.getAudioTracks()[0].enabled) && (void 0 !== o.unmuteAudio && o.unmuteAudio(), o.audioEnabled = !0, o.stream.getAudioTracks()[0].enabled = !0, !0)
                }, o.disableAudio = function () {
                    return u.default.debug("Disable audio stream with id", o.streamId), !!(o.hasAudio() && o.initialized && void 0 !== o.stream && o.stream.getAudioTracks()[0].enabled) && (void 0 !== o.muteAudio && o.muteAudio(), o.audioEnabled = !1, o.stream.getAudioTracks()[0].enabled = !1, o.sid && m.report.audioSendingStopped(o.sid, {
                        succ: !0,
                        reason: "muteAudio"
                    }), !0)
                }, o.enableVideo = function () {
                    return u.default.debug("Enable video stream with id", o.streamId), !(!o.initialized || void 0 === o.stream || !o.stream.getVideoTracks().length || !0 === o.stream.getVideoTracks()[0].enabled) && (void 0 !== o.unmuteVideo && o.unmuteVideo(), o.pc && (o.pc.isVideoMute = !1), o.videoEnabled = !0, o.stream.getVideoTracks()[0].enabled = !0, o.lowStream && o.lowStream.enableVideo(), !0)
                }, o.disableVideo = function () {
                    return u.default.debug("Disable video stream with id", o.streamId), !!(o.initialized && void 0 !== o.stream && o.stream.getVideoTracks().length && o.stream.getVideoTracks()[0].enabled) && (void 0 !== o.muteVideo && o.muteVideo(), o.pc && (o.pc.isVideoMute = !0), o.videoEnabled = !1, o.stream.getVideoTracks()[0].enabled = !1, o.lowStream && o.lowStream.disableVideo(), o.sid && m.report.videoSendingStopped(o.sid, {
                        succ: !0,
                        reason: "muteVideo"
                    }), !0)
                }, o.setAudioOutput = function (e, t, i) {
                    return "string" != typeof e ? (u.default.error("setAudioOutput Invalid Parameter", e), i && i(v.default.INVALID_PARAMETER)) : (o.audioOutput = e, o.player ? void o.player.setAudioOutput(e, t, i) : t && t())
                }, o.play = function (e, t) {
                    o.isPlaying() ? u.default.error("Stream.play(): Stream is already playing") : !o.local || o.video || o.screen ? void 0 !== e && (o.player = new a.default({
                        id: o.getId(),
                        stream: o,
                        elementID: e,
                        options: void 0,
                        url: t
                    })) : o.hasAudio() && (o.player = new a.default({
                        id: o.getId(),
                        stream: o,
                        elementID: e,
                        options: void 0,
                    ...
                    u.default.debug("Stop stream player with id", o.streamId), o.player ? (o.player.destroy(), delete o.player) : u.default.error("Stream.stop(): Stream is not playing")
                    ...
                    o.dispatchEvent(i), Promise.all(i.promises).then(function (t) {
                        var i = Object.assign.apply(Object, t);
                        e && setTimeout(e.bind(o, i), 0)
                    }).catch(function (e) {
                        t ? setTimeout(t.bind(o, e), 0) : u.default.error("Stream.getStats", e)
                    })
                    ...
                    return new Promise(function (e, t) {
                        ...
                        return o.pc.isSubscriber ? (0, l.isFireFox)() && ((0, p.setStat)(e, "videoReceiveResolutionHeight", o.videoHeight), (0, p.setStat)(e, "videoReceiveResolutionWidth", o.videoWidth)) : (((0, l.isSafari)() || (0, l.isFireFox)()) && ((0, p.setStat)(e, "videoSendResolutionHeight", o.videoHeight), (0, p.setStat)(e, "videoSendResolutionWidth", o.videoWidth)), ((0, l.isSafari)() || (0, l.isFireFox)()) && o.uplinkStats && (0, p.setStat)(e, "videoSendPacketsLost", o.uplinkStats.uplink_cumulative_lost)), Promise.resolve(e)
                    })
                }, o.getAudioLevel = function () {
                    return o.audioLevelHelper ? o.audioLevelHelper.getAudioLevel() : o.stream ? 0 !== o.stream.getAudioTracks().length ? (o.audioLevelHelper = new f.audioLevelHelper(o.stream), o.audioLevelHelper.getAudioLevel()) : void u.default.warning("can't get audioLevel beacuse no audio trace in stream") : (u.default.warning("can't get audioLevel beacuse no stream exist"), 0)
                }, o
            },
            S = function (e) {
                return u.default.debug("Create stream"), _(e)
            },
            E = function (e, t) {
        ...
        t.Stream = _, t.createStream = S, t.getDevices = E
    }, function (e, t, i) {
        function n(e, t, i) {
            var n = t && i || 0;
        ...
        var r = i(23),
            ...
            I = function (e, t, i) {
                if ({}.config = e, navigator.getMedia = navigator.getUserMedia || navigator.webkitGetUserMedia || navigator.mozGetUserMedia || navigator.msGetUserMedia, e.screen) {
                    ...
                    if (n) return void(n.desktopCapturer ? new _.default(e, t, i).shareScreen(n) : i(S.ErrorCodes.ELECTRON_NOT_SUPPORT_SHARING_SCREEN));
                    if (g.default.debug("Screen access requested"), null !== window.navigator.userAgent.match("Firefox")) {
                        ...
                        try {
                            chrome.runtime.sendMessage(o, {
                                ...
                                if (void 0 === n) return g.default.debug("Access to screen denied"), void i({
        ...
        var n = i(1),
            ...
            u = function (e, t, i, n) {
                ...
                o && (u.detail[5] = JSON.stringify(o)), (0, s.post)(e, u, function (o) {
                    try {
                        var s = JSON.parse(o).res,
                            u = s.code
                    } catch (e) {
                        var l = "requestChooseServer failed with unexpected body " + o;
                        return a.default.error(l), n(l)
                    }
                    if (u) {
                    ...
                    if (s.addresses.forEach(function (e) {
                            var t;
                            e.ip && e.port ? (e.ip.match(/^[\.\:\d]+$/) ? t = "webrtc-" + e.ip.replace(/[^\d]/g, "-") + ".agora.io:" + e.port : (a.default.info("Cannot recognized as IP address " + e.ip + ". Used As Host instead"), t = e.ip + ":" + e.port), f.push(t)) : a.default.error("Invalid address format ", e)
                        }), !f.length) {
                        a.default.error("Empty Address response", s);
            ...
            l = function (e, t, i) {
                for (var n = (new Date).getTime(), o = !1, s = !0, l = function (i, r) {
                        if (o) d.report.joinChooseServer(e.sid, {
                            ...
                            if (clearTimeout(_), o = !0, a.default.debug("Get gateway address:", i.gateway_addr), e.proxyServer) {
                                for (var s = i.gateway_addr, c = 0; c < s.length; c++) {
                                    var u = s[c].split(":");
                                    i.gateway_addr[c] = e.proxyServer + "/ws/?h=" + u[0] + "&p=" + u[1]
                                }
                                a.default.debug("Get gateway address:", i.gateway_addr)
                            }
                            t(i), d.report.joinChooseServer(e.sid, {
                                lts: n,
                                succ: !0,
                                csAddr: r,
                                serverList: i.gateway_addr,
                        ...
                        s && (a.default.error(e, t, n), n && !c.JOIN_CS_RETRY_LIST.includes(n) && (s = !1, i(n)))
                    }, f = r.WEBCS_DOMAIN, m = 0; m < f.length; ++m) {
                    var g;
                    if ("string" == typeof f[m]) {
                        var v = f[m];
                        g = e.proxyServer ? "https://" + e.proxyServer + "/ap/?url=" + v + "/api/v1" : "https://" + v + "/api/v1", a.default.debug("Connect to choose_server: " + g), u(g, e, l, p)
                    } else a.default.error("Invalid Host", f[m])
                }
                    ...
                    if (!o)
                        for (var t = r.WEBCS_DOMAIN_BACKUP_LIST, i = 0; i < t.length; ++i) {
                            if ("string" == typeof t[i]) {
                                var n = t[i];
                                g = e.proxyServer ? "https://" + e.proxyServer + "/ap/?url=" + n + "/api/v1" : "https://" + n + "/api/v1", a.default.debug("Connect to backup_choose_server: " + g), u(g, e, l, p)
                            } else a.default.error("Invalid Host", t[i])
                        }
                }, 1e3);
                setTimeout(function () {
                    !o && s && i()
            ...
            p = function (e, t, i) {
                ...
                ! function i() {
                    n || l(e, function (e) {
                        n = !0, clearTimeout(r), t(e)
                    }, function (e) {
                        if (e) return void a.default.info("Join failed: " + e);
                        a.default.debug("Request gateway list will be restart in " + o + "s"), r = setTimeout(function () {
                            i()
        ...
        var n = window.AudioContext || webkitAudioContext,
            r = null,
            o = function () {
                return !r && n && (r = new n), r
            },
            a = function () {
                return !!n
            };
        t.GetAudioContext = o, t.checkAudioContext = a
    }, function (e, t, i) {
        "use strict";
            ...
            l = function (e) {
                ...
                if (t.id = e.id, t.url = e.url, t.stream = e.stream.stream, t.elementID = e.elementID, t.setAudioOutput = function (e, i, n) {
                        ...
                        return r ? r.setSinkId ? void r.setSinkId(e).then(function () {
                            return s.default.debug("video " + t.id + " setAudioOutput " + e + " SUCCESS"), r == t.video && t.audio ? t.audio.setSinkId(e) : Promise.resolve()
                        }).then(function () {
                            return s.default.debug("audio " + t.id + " setAudioOutput " + e + " SUCCESS"), i && i()
                        }).catch(function (e) {
                            return s.default.error("VideoPlayer.setAudioOutput", e), n && n(e)
                        }) : (s.default.error(u.default.WEB_API_NOT_SUPPORTED), n && n(u.default.WEB_API_NOT_SUPPORTED)) : (s.default.error(u.default.PLAYER_NOT_FOUND), n && n(u.default.PLAYER_NOT_FOUND))
                    }, t.destroy = function () {
                        (0, d.setSrcObject)(t.video, null), (0, d.setSrcObject)(t.audio, null), t.video.pause(), delete t.resizer, document.getElementById(t.div.id) && t.parentNode.contains(t.div) && t.parentNode.removeChild(t.div)
                        ...
                        ! function e() {
                            if (t.video.videoWidth * t.video.videoHeight > 4) return void s.default.debug("video dimensions:", t.video.videoWidth, t.video.videoHeight);
                            setTimeout(e, 50)
                        }()
                    }), e.stream.hasVideo() || e.stream.hasScreen()) t.div.appendChild(t.video), t.div.appendChild(t.audio), (0, d.attachMediaStream)(t.video, e.stream.stream), (0, d.attachMediaStream)(t.audio, e.stream.stream);
                ...
                return t.processSignalingMessage = function (e) {
                    ...
                    if (t.actionNeeded) {
                        if ("new" === t.state || "established" === t.state) t.peerConnection.createOffer(function (e) {
                            if (e.sdp = n(e.sdp), r.default.debug("Changed", e.sdp), e.sdp !== t.prevOffer) return t.peerConnection.setLocalDescription(e), t.state = "preparing-offer", void t.markActionNeeded();
                            ...
                            var i = new Date;
                            r.default.debug(i.getTime() + ": Starting ICE in responder"), t.iceStarted = !0
                        }, function (e) {
        ...
        var n = i(0),
            ...
            a = function (e) {
                ...
                t.uid = e.uid, t.isVideoMute = e.isVideoMute, t.isSubscriber = e.isSubscriber, t.pc_config = {
                    iceServers: [{
                    ...
                    var i, n, o, a;
                    i = t.peerConnection.localDescription.sdp, n = i.match(/a=candidate:.+typ\ssrflx.+\r\n/), o = i.match(/a=candidate:.+typ\shost.+\r\n/), a = i.match(/a=candidate:.+typ\srelay.+\r\n/), 0 === t.iceCandidateCount && (t.timeout = setTimeout(function () {
                        t.moreIceComing && (t.moreIceComing = !1, t.markActionNeeded())
                    }, 1e3)), null === n && null === o && null === a || void 0 !== t.ice || (r.default.debug("srflx candidate : " + n + " relay candidate: " + a + " host candidate : " + o), clearTimeout(t.timeout), t.ice = 0, t.moreIceComing = !1, t.markActionNeeded()), t.iceCandidateCount = t.iceCandidateCount + 1
                ...
                return t.processSignalingMessage = function (e) {
                    ...
                    t.peerConnection.getStats(null, function (i) {
                        ...
                        Object.keys(i).forEach(function (e) {
                            var t = i[e];
                            r.push(t), "ssrc" !== t.type && "VideoBwe" !== t.type || (o = t.timestamp, n.push(t))
                        }), n.push({
                            id: "time",
        ...
        var n = i(0),
            ...
            a = function (e) {
                ...
                t.uid = e.uid, t.isVideoMute = e.isVideoMute, t.isSubscriber = e.isSubscriber, t.pc_config = {
                    ...
                    t.incomingMessage = o, "new" === t.state ? "OFFER" === o.messageType ? (o.sdp = l(o.sdp), n = {
                        sdp: o.sdp,
                        type: "offer"
        ...
        var n = function (e, t, i) {
            ...
            return n.callback = t, n.config = e, n.error = i, n.selectSource = function (e, t, i) {
                /**
                 * sdk2.4与sdk2.0老版本功能不一致，新版本分享有选窗口功能， 老版本没有这个功能，所以注释掉
                 * 此处只是注释和 添加 t && t(e[0].id) 如需回复 去掉 t && t(e[0].id) 和注释即可
                 * @time 2018/8/29
                 * @author shijh
                 */
                t && t(e[0].id)
                ...
                //     document.body.removeChild(c), i && i("NotAllowedError")
        ...
        t.setStat = r, t.publishStatsFilter = o, t.subscribeStatsFilter = a
    }, function (e, t, i) {
        "use strict";
        ...
        var r = i(31),
            ...
            h = function (e) {
                ...
                return t.aespassword = null, t.aesmode = E.ENCRYPTION_MODE_NONE, t.hasPublished = !1, t.renewToken = function (e, i, n) {
                    t.gatewayClient || (s.default.error("renewToken Failed. GatewayClient not Exist"), (0, u.safeCall)(n, c.default.INVALID_OPERATION)), t.key ? (t.key = e, t.gatewayClient.renewToken(e, i, n)) : (s.default.error("renewToken should not be called before user join"), (0, u.safeCall)(n, c.default.INVALID_OPERATION))
                    ...
                    if ((0, f.isChromeKernel)() && (0, f.getChromeKernelVersion)() <= 48) return void(n ? n(c.default.BAD_ENVIRONMENT) : (0, u.popBanTip)());
                    s.default.info("Initializing AgoraRTC client, appId: " + t + "."), e.appId = t, e.sessionId = (0, u.generateSessionId)(), i && i()
                    ...
                    E.ENCRYPTION_MODES.includes(e) || (e = E.ENCRYPTION_MODE_NONE), t.aesmode = e
                    ...
                    return "iOS" === (0, f.getBrowserOS)() ? (p.report.streamSwitch(e.sessionId, {
                        ...
                        isdual: !0,
                        succ: !1
                    }), n && n(c.default.IOS_NOT_SUPPORT)) : (0, f.isWeChatBrowser)() ? (p.report.streamSwitch(e.sessionId, {
                        lts: (new Date).getTime(),
                        isdual: !0,
                        succ: !1
                    }), n && n(c.default.WECHAT_NOT_SUPPORT)) : (p.report.streamSwitch(e.sessionId, {
                        lts: (new Date).getTime(),
                        isdual: !0,
                        succ: !0
                    ...
                    p.report.streamSwitch(e.sessionId, {
                        ...
                        isdual: !1,
                        succ: !0
                    }), t.isDualStream = !1, 0 === t.highStreamState ? t._unpublishLowStream(i, function (e) {
                        s.default.warning(e), n && n(c.default.DISABLE_DUALSTREAM_FAILED)
                    }) : 1 === t.highStreamState ? n && n(c.default.STILL_ON_PUBLISHING) : i && i()
                }, t._createLowStream = function (e, i) {
                    if (!t.highStream || !t.highStream.stream) return void(i && i(c.default.HIGH_STREAM_NOT_VIDEO_TRACE));
                    var n = Object.assign({}, t.highStream.params);
                    if (n.streamID += 1, n.audio = !1, !n.video) return void(i && i(c.default.HIGH_STREAM_NOT_VIDEO_TRACE));
                    var r = t.highStream.stream.getVideoTracks()[0];
                    if (!r) return void(i && i(c.default.HIGH_STREAM_NOT_VIDEO_TRACE));
                    ...
                    return 2 !== t.lowStreamState ? i && i(c.default.LOW_STREAM_ALREADY_PUBLISHED) : t.highStream && t.highStream.hasScreen() ? i && i(c.default.SHARING_SCREEN_NOT_SUPPORT) : void t._getLowStream(function (n) {
                    ...
                    if (i && "string" != typeof i) return s.default.warning("Param channelKey should be string"), d && d(c.default.INVALID_PARAMETER);
                    if ("string" != typeof n) return s.default.warning("Param channel should be string"), d && d(c.default.INVALID_PARAMETER);
                    if (r && ("number" != typeof r || !(0, u.is32Uint)(r))) return s.default.warning("Param uid should be number"), d && d(c.default.INVALID_PARAMETER);
                    ...
                    if (t.aespassword && t.aesmode !== E.ENCRYPTION_MODE_NONE && Object.assign(f, {
                            ...
                            mode: e.mode,
                            succ: !0
                        }), t.onSuccess = a, t.onFailure = d, t.channel = n, t.gatewayClient.state !== o.default.DISCONNECTED) return s.default.error("Client already in connecting/connected state"), d && d(c.default.INVALID_OPERATION), void p.report.joinGateway(f.sid, {
                        lts: Date.now(),
                        succ: !1,
                        ec: c.default.INVALID_OPERATION,
                        addr: null
                    });
                    t.gatewayClient.state = o.default.CONNECTING, (0, l.getGatewayList)(f, function (r) {
                        s.default.info("Joining channel: " + n), t.key = i || e.appId, f.cid = r.cid, f.uid = r.uid, r.uni_lbs_ip && r.uni_lbs_ip[1] && (f.uni_lbs_ip = r.uni_lbs_ip[1]), f.gatewayAddr = r.gateway_addr, t.joinInfo = f, t.gatewayClient.join(f, t.key, function (e) {
                            s.default.info("Join channel " + n + " success, join with uid: " + e + "."), a && a(e)
                        }, d)
                    }, d)
                }, t.renewChannelKey = function (e, i, n) {
                    void 0 === t.key ? (s.default.error("renewChannelKey should not be called before user join"), (0, u.safeCall)(n, c.default.INVALID_OPERATION)) : (t.key = e, t.gatewayClient.key = e, t.gatewayClient.rejoin(), (0, u.safeCall)(i))
                }, t.leave = function (e, i) {
                    /**
                     * bugfix: 断网退出后，联网，re-join 有声音bug
                     * C.channel = '' 使得无法re-join
                     */
                    t.channel = ''
                    s.default.info("Leaving channel"), t.gatewayClient.leave(e, i)
                    /**
                     * bugfix: 断网一定时间后后会重连，与我们现有逻辑是不服的
                     * 所以在leave的时候closeGateway
                     * @time 2018-9-14
                     * @author sjh
                     */
                    t.gatewayClient.closeGateway()
                }, t._publish = function (i, n, r) {
                    if (2 !== t.highStreamState) return s.default.warning("Can't publish stream when stream already publish", i.getId()), r && r(c.default.STREAM_ALREADY_PUBLISHED);
                    s.default.info("Publishing stream, uid: ", i.getId()), t.highStream = i, t.highStreamState = 1, t.highStream.streamId = t.joinInfo.uid, t.hasPublished = !1, t.gatewayClient.publish(i, function () {
                        i.sid = e.sessionId, t.highStreamState = 0, s.default.info("Publish success, uid:", i.getId()), t.isDualStream ? t._publishLowStream(function () {
                            n && n()
                        }, function () {
                            n && n()
                        }) : n && n()
                    ...
                    if (0 !== t.highStreamState) return s.default.warning("Can't unpublish stream when stream not publish"), n && n(c.default.STREAM_NOT_YET_PUBLISHED);
                    ...
                    s.default.info("Subscribe stream, uid: ", e.getId()), t.gatewayClient.subscribe(e, null, i)
                }, t.unsubscribe = function (e, i) {
                    s.default.info("Unsubscribe stream, uid: ", e.getId()), t.gatewayClient.unsubscribe(e, null, i)
                    ...
                    Object.assign(R, e), t.gatewayClient.setLiveTranscoding(R)
                }, t.enableAudioVolumeIndicator = function (e, i) {
                    e = e || 2e3, i = i || 3, t.audioVolumeIndication = t.audioVolumeIndication || {
                        enabled: !0
                    }, t.audioVolumeIndication.interval = e, t.audioVolumeIndication.smooth = i, t.audioVolumeIndication = {
                        interval: e,
                        smooth: i
                    }, s.default.info("enableAudioVolumeIndicator interval " + e + " smooth " + i), t.gatewayClient.enableAudioVolumeIndicator(e, i)
                    ...
                    t.gatewayClient.closeGateway(), t.gatewayClient.socket = void 0, t.gatewayClient.hasChangeBGPAddress = !0, t.joinInfo.multiIP = e.arg.option, t.gatewayClient.state = o.default.CONNECTING, (0, l.getGatewayList)(t.joinInfo, function (e) {
                        s.default.info("Joining channel: " + t.channel), t.joinInfo.cid = e.cid, t.joinInfo.uid = e.uid, t.joinInfo.uni_lbs_ip = e.uni_lbs_ip, t.joinInfo.gatewayAddr = e.gateway_addr, t.onSuccess ? t.gatewayClient.join(t.joinInfo, t.key, function (e) {
                            s.default.info("Join channel " + t.channel + " success");
                            var i = t.onSuccess;
                            t.onSuccess = null, t.onFailure = null, i(e)
                        }, t.onFailure) : (t.gatewayClient.joinInfo = Object.assign({}, t.joinInfo), t.gatewayClient.rejoin())
                    }, t.onFailure)
                    ...
                    s.default.debug("Start reconnect remote peerConnection :", e.stream.getId()), t.gatewayClient.dispatchEvent({
                        ...
                        t.gatewayClient.subscribe(e.stream, function () {
                            ...
                            s.default.debug("Reconnect remote peerConnection failed:" + i), t.gatewayClient.dispatchEvent({
                                type: "stream-reconnect-end",
                                id: e.stream.getId()
                            })
                        })
            ...
            y = function (e) {
                return E.CLIENT_MODES.includes(e.mode) ? E.CLIENT_CODECS.includes(e.codec) ? e.mode == E.CLIENT_MODE_H264_INTEROP && e.codec !== E.CLIENT_CODEC_H264 && c.default.CLIENT_MODE_CODEC_MISMATCH : c.default.INVALID_CLIENT_CODEC : c.default.INVALID_CLIENT_MODE
            },
            A = function (e) {
                switch (e.mode) {
            ...
            C = function (e) {
                e = Object.assign({}, e || {}), e.codec || (e.codec = b(e.mode));
                var t = y(e);
                if (t) throw s.default.error("Invalid parameter setting MODE : " + e.mode + " CODEC : " + e.codec + " ERROR " + t), new Error(t);
                return s.default.info("Creating client , MODE : " + e.mode + " CODEC : " + e.codec), A(e), h(e)
            },
            O = function () {
                return s.default.info("Creating client , MODE : rtc"), s.default.warning("createRtcClient is deprecated."), h({
                    mode: "rtc"
                })
            },
            T = function (e) {
                var t = "host";
                return e && "audience" === e.role && (t = e.role), s.default.info("Creating client , MODE : live"), s.default.warning("createLiveClient is deprecated."), h({
                    mode: "live",
                    role: t
                })
            };
        t.createClient = C, t.createRtcClient = O, t.createLiveClient = T, t.TranscodingUser = I, t.LiveTranscoding = R
    }, function (e, t, i) {
        "use strict";
            ...
            b = function e(t) {
                ...
                Y.p2pCounter = (0, E.random)(1e5), Y.generateP2PId = function () {
                    ...
                    var o = (new Date).getTime(),
                        s = e.uid;
                    if (Y.state !== W) return l.default.error("GatewayClient.join Failed: state ", Y.state), r && r(f.default.INVALID_OPERATION), void S.report.joinGateway(e.sid, {
                        lts: o,
                        succ: !1,
                        ec: f.default.INVALID_OPERATION,
                        addr: null
                    });
                    if (null !== s && void 0 !== s && parseInt(s) !== s) return l.default.error("Input uid is invalid"), Y.state = H, r && r(f.default.INVALID_PARAMETER), void S.report.joinGateway(e.sid, {
                        lts: o,
                        succ: !1,
                    ...
                    if (d) return Y.state = H, r && r(d), void S.report.joinGateway(e.sid, {
                        lts: o,
                        succ: !1,
                        ec: d,
                        addr: null
                    });
                    Y.joinInfo = Object.assign({}, e), Y.uid = s, Y.key = t, ie(e, function (t) {
                        Y.state = G, l.default.debug("Connected to gateway server"), Y.pingTimer = setInterval(function () {
                            var e = Date.now();
                            ne(n(), function () {
                                var t = Date.now() - e;
                                ne(a({
                            ...
                            if (S.report.joinGateway(e.sid, {
                                ...
                                l.default.info("Calling Leave() once joined");
                                var n = Y.leaveOnConnected;
                                Y.leaveOnConnected = null, Y.leave(n.onSuccess, n.onFailure)
                            }
                        }, function (t) {
                            if (l.default.error("User join failed [" + t + "]"), R.default[t] && Y.rejoinAttempt < 4) {
                                if (Y._doWithAction(R.default[t], i, r), Y.leaveOnConnected) {
                                    l.default.error("Calling Leave() once joined: Join Failed");
                                    var n = Y.leaveOnConnected;
                                    Y.leaveOnConnected = null, n.onFailure(f.default.JOIN_CHANNEL_FAILED)
                                }
                            } else r && r(t);
                        ...
                        l.default.error("User join failed [" + t + "]"), r && r(t), S.report.joinGateway(e.sid, {
                            lts: o,
                            succ: !1,
                            ec: t,
                            addr: Y.socket.getURL()
                    ...
                    switch (Y.state) {
                        case H:
                            return l.default.debug("Client Already in DISCONNECTED status"), void J(e);
                        case K:
                            return l.default.error("Client Already in DISCONNECTING status"), void J(t, f.default.INVALID_OPERATION);
                        case W:
                            return Y.leaveOnConnected ? (l.default.error("Client.leave() already called"), void J(t, f.default.INVALID_OPERATION)) : (l.default.debug("Client connecting. Waiting for Client Fully Connected(And leave)"), void(Y.leaveOnConnected = {
                                onSuccess: e,
                                onFailure: t
                            }))
                    }
                    var i = y.unregister(Y);
                    if (i) return void l.default.error(i);
                    Y.state = K, clearInterval(Y.pingTimer);
                    for (var n in Y.timers) Y.timers.hasOwnProperty(n) && clearInterval(Y.timers[n]);
                    ne(m(), function (t) {
                        Y.socket.close(), Y.socket = void 0, l.default.info("Leave channel success"), Y.state = H, e && e(t)
                    }, function (e) {
                        l.default.error("Leave Channel Failed", e), Y.state = G, t && t(e)
                    });
                    for (var n in Y.localStreams)
                        if (Y.localStreams.hasOwnProperty(n)) {
                            var r = Y.localStreams[n];
                            delete Y.localStreams[n], void 0 !== r.pc && (r.pc.close(), r.pc = void 0)
                        }
                    ae()
                }, Y.publish = function (e, t, i) {
                    var n = (new Date).getTime(),
                        o = !1;
                    if (e.publishLTS = n, "object" !== (void 0 === e ? "undefined" : r(e)) || null === e) return l.default.error("Invalid local stream"), i && i(f.default.INVALID_LOCAL_STREAM), void S.report.publish(Y.joinInfo.sid, {
                        lts: n,
                        succ: !1,
                        ec: f.default.INVALID_LOCAL_STREAM
                    });
                    if (null === e.stream && void 0 === e.url) return l.default.error("Invalid local media stream"), i && i(f.default.INVALID_LOCAL_STREAM), void S.report.publish(Y.joinInfo.sid, {
                        lts: n,
                        succ: !1,
                        ec: f.default.INVALID_LOCAL_STREAM
                    });
                    if (Y.state !== G) return l.default.error("User is not in the session"), i && i(f.default.INVALID_OPERATION), void S.report.publish(Y.joinInfo.sid, {
                        lts: n,
                        succ: !1,
                        ec: f.default.INVALID_OPERATION
                    });
                    ...
                    if (e.local && void 0 === Y.localStreams[e.getId()] && (e.hasAudio() || e.hasVideo() || e.hasScreen())) {
                        ...
                        if (Y.p2ps.set(s, e), e.p2pId = s, void 0 !== e.url) re(P({
                            ...
                            Y.localStreams[e.getId()] = e, e.pc = (0, d.Connection)({
                                callback: function (r) {
                                    l.default.debug("SDP exchange in publish : send offer --  ", JSON.parse(r)), re(P({
                                        state: "offer",
                                        id: e.getId(),
                                        audio: e.hasAudio(),
                                        ...
                                        if ("error" === a) return l.default.error("Publish local stream failed"), i && i(f.default.PUBLISH_STREAM_FAILED), void S.report.publish(Y.joinInfo.sid, {
                                            lts: n,
                                            succ: !1,
                                            localSDP: r,
                                        ...
                                        e.pc.onsignalingmessage = function (t) {
                                            e.pc.onsignalingmessage = function () {}, re(P({
                                                state: "ok",
                                                id: e.getId(),
                                                audio: e.hasAudio(),
                                                video: e.hasVideo(),
                                                ...
                                                attributes: e.getAttributes(),
                                                mode: Y.mode
                                            }, t)), e.setUserId(d.id), l.default.info("Local stream published with uid", d.id), e.onClose = function () {
                                                Y.unpublish(e)
                                            ...
                                            if ("failed" === r) {
                                                if (void 0 != Y.timers[e.getId()] && (clearInterval(Y.timers[e.getId()]), clearInterval(Y.timers[e.getId()] + "_RelatedStats")), l.default.error("Publisher connection is lost -- streamId: " + e.getId() + " p2pId: " + s), Y.p2ps.delete(s), l.default.debug("publish p2p failed: ", Y.p2ps), !o) return o = !0, S.report.publish(Y.joinInfo.sid, {
                                                    lts: n,
                                                    succ: !1,
                                            ...
                                            } else if ("connected" === r && (l.default.debug("publish p2p connected: ", Y.p2ps), !o)) return o = !0, S.report.publish(Y.joinInfo.sid, {
                                                lts: n,
                                                succ: !0,
                                                ec: null
                                            }), t && t()
                                        }, l.default.debug("SDP exchange in publish : receive answer --  ", JSON.parse(a)), e.pc.processSignalingMessage(a)
                                    })
                                },
                                audio: e.hasAudio(),
                                video: e.hasVideo(),
                            ...
                            }), e.pc.addStream(e.stream), l.default.debug("PeerConnection add stream :", e.stream), Y.timers[e.getId()] = setInterval(function () {
                            ...
                            u(), Y.timers[e.getId() + "_RelatedStats"] = setInterval(u, 1e3)
                        }
                    }
                }, Y.unpublish = function (e, t, i) {
                    return "object" !== (void 0 === e ? "undefined" : r(e)) || null === e ? (l.default.error("Invalid local stream"), void J(i, f.default.INVALID_LOCAL_STREAM)) : Y.state !== G ? (l.default.error("User not in the session"), void J(i, f.default.INVALID_OPERATION)) : (void 0 != Y.timers[e.getId()] && (clearInterval(Y.timers[e.getId()]), clearInterval(Y.timers[e.getId() + "_RelatedStats"])), void(void 0 !== Y.socket ? e.local && void 0 !== Y.localStreams[e.getId()] ? (delete Y.localStreams[e.getId()], ne(A(e.getUserId())), (e.hasAudio() || e.hasVideo() || e.hasScreen()) && void 0 === e.url && void 0 !== e.pc && (e.pc.close(), e.pc = void 0), e.onClose = void 0, e.unmuteAudio = void 0, e.muteAudio = void 0, e.unmuteVideo = void 0, e.muteVideo = void 0, Y.p2ps.delete(e.p2pId), t && t()) : (l.default.error("Invalid local stream"), J(i, f.default.INVALID_LOCAL_STREAM)) : (l.default.error("User not in the session"), J(i, f.default.INVALID_OPERATION))))
                }, Y.subscribe = function (e, t, i) {
                    var n = (new Date).getTime();
                    e.subscribeLTS = n;
                    var o = !1;
                    if ("object" !== (void 0 === e ? "undefined" : r(e)) || null === e) return l.default.error("Invalid remote stream"), i && i(f.default.INVALID_REMOTE_STREAM), void S.report.subscribe(Y.joinInfo.sid, {
                        lts: n,
                        succ: !1,
                        peerid: e.getId() + "",
                        ec: f.default.INVALID_REMOTE_STREAM
                    });
                    if (Y.state !== G && (l.default.error("User is not in the session"), !o)) return o = !0, S.report.subscribe(Y.joinInfo.sid, {
                        lts: n,
                        succ: !1,
                        peerid: e.getId() + "",
                        ec: f.default.INVALID_OPERATION
                    ...
                    if (!e.local && Y.remoteStreams.hasOwnProperty(e.getId()))
                        if (e.hasAudio() || e.hasVideo() || e.hasScreen()) {
                            ...
                            Y.p2ps.set(a, e), e.p2pId = a, e.pc = (0, d.Connection)({
                                callback: function (t) {
                                    l.default.debug("SDP exchange in subscribe : send offer --  ", JSON.parse(t)), re(V({
                                        streamId: e.getId(),
                                        audio: !0,
                                        video: !0,
                                        mode: Y.mode,
                                        ...
                                        if ("error" === t) return l.default.error("Subscribe remote stream failed, closing stream ", e.getId()), e.close(), i && i(f.default.SUBSCRIBE_STREAM_FAILED), void S.report.subscribe(Y.joinInfo.sid, {
                                            lts: n,
                                            succ: !1,
                                            peerid: e.getId() + "",
                                ...
                                if ("ontrack" === i && "video" === t.track.kind || "onaddstream" === i) {
                                    if (l.default.info("Remote stream subscribed with uid ", e.getId()), Y.remoteStreams[e.getId()].stream = "onaddstream" === i ? t.stream : t.streams[0], Y.remoteStreams[e.getId()].hasVideo()) {
                                        if ((0, h.isFireFox)()) {
                                            var n = Y.remoteStreams[e.getId()].stream;
                                            (0, E.vsResHack)(n, function (t, i) {
                                ...
                                e && e.pc && e.pc.getStats && e.pc.getStatsRate(function (t) {
                                    t.forEach(function (t) {
                                        if (t && t.id) {
                                            if (/_send$/.test(t.id) || /^time$/.test(t.id) || /^bweforvideo$/.test(t.id)) return; - 1 !== t.id.indexOf("inbound_rtp") && "video" === t.mediaType && (t.googFrameWidthReceived = e.videoWidth + "", t.googFrameHeightReceived = e.videoHeight + ""), re(F(e.getId(), t), null, null)
                                        } else;
                                    })
                                })
                                    ...
                                    t.forEach(function (t) {
                                        if ("audio" === t.mediaType) {
                                            ...
                                            if (Y.activeSpeaker !== r[0]) {
                                                ...
                                                Y.dispatchEvent(o), Y.activeSpeaker = r[0], l.default.debug("Update active speaker:" + Y.activeSpeaker)
                                            }
                                        }
                                    })
                                })
                            }, 50), e.pc.oniceconnectionstatechange = function (r) {
                                if ("failed" === r) void 0 != Y.timers[e.getId()] && (clearInterval(Y.timers[e.getId()]), clearInterval(Y.timers[e.getId()] + "audio")), l.default.error("Subscriber connection is lost -- streamId: " + e.getId() + " p2pId: " + a), l.default.debug("subscribe p2p failed: ", Y.p2ps), o || (o = !0, i && i(f.default.PEERCONNECTION_FAILED), S.report.subscribe(Y.joinInfo.sid, {
                                    lts: n,
                                    succ: !1,
                                    peerid: e.getId() + "",
                                    ec: f.default.PEERCONNECTION_FAILED
                                ...
                                else if ("connected" === r && (l.default.debug("subscribe p2p connected: ", Y.p2ps), !o)) return o = !0, S.report.subscribe(Y.joinInfo.sid, {
                                    lts: n,
                                    succ: !0,
                                    peerid: e.getId() + "",
                                    ec: null
                                    ...
                                    e.pc ? e.pc.getStats(function (t) {
                                        t.forEach(function (t) {
                                            -1 === t.id.indexOf("recv") && -1 === t.id.indexOf("inbound_rtp") && -1 === t.id.indexOf("InboundRTP") || "video" === t.mediaType && (t.framesDecoded > 0 || t.googFramesDecoded > 0) && (clearInterval(Y.firstFrameTimer.get(e.getId())), Y.firstFrameTimer.delete(e.getId()), S.report.firstRemoteFrame(Y.joinInfo.sid, {
                                                lts: (new Date).getTime(),
                                                peerid: e.getId() + "",
                                                succ: !0,
                        ...
                        } else l.default.error("Invalid remote stream"), o || (o = !0, i && i(f.default.INVALID_REMOTE_STREAM), S.report.subscribe(Y.joinInfo.sid, {
                            lts: n,
                            succ: !1,
                            peerid: e.getId() + "",
                            ec: f.default.INVALID_REMOTE_STREAM
                        }));
                    else l.default.error("No such remote stream"), o || (o = !0, i && i(f.default.NO_SUCH_REMOTE_STREAM), S.report.subscribe(Y.joinInfo.sid, {
                        lts: n,
                        succ: !1,
                        peerid: e.getId() + "",
                        ec: f.default.NO_SUCH_REMOTE_STREAM
                    }))
                }, Y.unsubscribe = function (e, t, i) {
                    return "object" !== (void 0 === e ? "undefined" : r(e)) || null === e ? (l.default.error("Invalid remote stream"), void J(i, f.default.INVALID_REMOTE_STREAM)) : Y.state !== G ? (l.default.error("User is not in the session"), void J(i, f.default.INVALID_OPERATION)) : (void 0 != Y.timers[e.getId()] && (clearInterval(Y.timers[e.getId()]), clearInterval(Y.timers[e.getId()] + "audio")), void 0 != Y.audioLevel[e.getId()] && delete Y.audioLevel[e.getId()], void 0 != Y.timer_counter[e.getId()] && delete Y.timer_counter[e.getId()], Y.remoteStreams.hasOwnProperty(e.getId()) ? Y.socket ? e.local ? (l.default.error("Invalid remote stream"), void J(i, f.default.INVALID_REMOTE_STREAM)) : (e.close(), void ne(C(e.getId()), function (n) {
                        if ("error" === n) return l.default.error("Unsubscribe remote stream failed", e.getId()), void J(i, f.default.UNSUBSCRIBE_STREAM_FAILED);
                        void 0 !== e.pc && (e.pc.close(), e.pc = void 0), e.onClose = void 0, e.unmuteAudio = void 0, e.muteAudio = void 0, e.unmuteVideo = void 0, e.muteVideo = void 0, Y.p2ps.delete(e.p2pId), l.default.info("Unsubscribe stream success"), Y.dispatchEvent((0, c.ClientEvent)({
                            type: "stream-removed",
                            uid: e.getId(),
                            stream: e
                        })), t && t()
                    }, i)) : (l.default.error("User is not in the session"), void J(i, f.default.INVALID_OPERATION)) : void J(i, f.default.NO_SUCH_REMOTE_STREAM))
                    ...
                    if (Y.state !== G) return void l.default.error("User is not in the session");
                    if (!e.local) {
                        switch (t) {
                    ...
                    e ? Y.key ? Y.state !== G ? (l.default.debug("Client is not connected. Trying to rejoin"), Y.key = e, Y.rejoin(), t && t()) : (l.default.debug("renewToken from " + Y.key + " to " + e), ne(N(e), t, i)) : (l.default.error("Client is previously joined without token"), i && i(f.default.INVALID_PARAMETER)) : (l.default.error("Invalid Token " + e), i && i(f.default.INVALID_PARAMETER))
                }, Y.setStreamFallbackOption = function (e, t) {
                    if (l.default.debug("Set stream fallback option " + e.getId() + " to " + t), "object" !== (void 0 === e ? "undefined" : r(e)) || null === e) return void l.default.error("Invalid remote stream");
                    if (Y.state !== G) return void l.default.error("User is not in the session");
                    if (!e.local) {
                        switch (t) {
                    ...
                    if (Y.liveStreams.set(e, t), l.default.debug("Start live streaming " + e + " transcodingEnabled " + t), Y.state !== G) return void l.default.error("User is not in the session");
                    ne(x(e, t), null, null)
                }, Y.stopLiveStreaming = function (e) {
                    if (l.default.debug("Stop live streaming " + e), Y.state !== G) return void l.default.error("User is not in the session");
                    Y.liveStreams.delete(e), ne(U(e), null, null)
                }, Y.setLiveTranscoding = function (e) {
                    if ((0, E.isLiveTranscodingValid)(e)) {
                        if (Y.transcoding = e, l.default.debug("Set live transcoding ", e), Y.state !== G) return void l.default.error("User is not in the session");
                        ne(B(e), null, null)
                    }
                }, Y.enableAudioVolumeIndicator = function (e, t) {
                    Y.audioVolumeIndication = Y.audioVolumeIndication || {
                        enabled: !0
                    }, Y.audioVolumeIndication.interval = e, Y.audioVolumeIndication.smooth = t, Y.resetAudioVolumeIndication()
                    ...
                    if (clearInterval(Y.timers.audioVolumeIndication), clearInterval(Y.timers.audioVolumeSampling), Y.audioVolumeIndication && Y.audioVolumeIndication.enabled && Y.audioVolumeIndication.interval) {
                        ...
                        Y.timers.audioVolumeSampling = setInterval(function () {
                            ...
                            l.default.debug("volume-indicator", JSON.stringify(o));
                    ...
                    l.default.debug("close gateway"), Y.state = H, Y.socket.close(), Z()
                };
                var z = function (e) {
                        return 1e3 * Math.min(30, Math.pow(2, e) - 1)
                    },
                    q = function (e, t) {
                        l.default.debug("Connect next gateway"), Y.state = H, Y.socket.close(), Z(), Y.reconnectMode = "tryNext", ee(e, t)
                    },
                    Q = function (e, t) {
                        l.default.debug("Reconnect gateway"), Y.state = H, Y.socket.close(), Z(), Y.reconnectMode = "retry", ee(e, t)
                    },
                    X = function () {
                        l.default.debug("quit gateway"), Y.state = H, Y.socket.close(), Z()
                    },
                    $ = function () {
                        l.default.debug("Reconnect gateway"), Y.state = H, Y.socket.close(), Z(), Y.reconnectMode = "recover", ee()
                    },
                    Z = function () {
                        ...
                        Y.p2ps.clear(), ae(), oe(), clearInterval(Y.pingTimer)
                    };
                Y.rejoin = function () {
                    Y.socket && (clearInterval(Y.pingTimer), Y.socket.close(), Y.socket = void 0), Y.state = W, ee()
                };
                var ee = function (e, t) {
                        e = e || function (e) {
                            l.default.info("User " + e + " is re-joined to " + Y.joinInfo.cname), Y.dispatchEvent((0, c.ClientEvent)({
                                type: "rejoin"
                            ...
                            l.default.error("Re-join to channel failed [" + e + "]"), Y.dispatchEvent((0, c.StreamEvent)({
                                type: "error",
                                reason: e
                            }))
                        }, Y.key ? (++Y.rejoinAttempt, Y.join(Y.joinInfo, Y.key, e, t)) : l.default.error("Connection recover failed [Invalid channel key]")
                    },
                    te = function (e) {
                        Y.socket = (0, s.default)(e, {
                            sid: Y.joinInfo.sid
                        })
                    },
                    ie = function (e, t, n) {
                        Y.onConnect = t, void 0 !== Y.socket ? "retry" === Y.reconnectMode ? (l.default.debug("Retry current gateway"), Y.socket.reconnect()) : "tryNext" === Y.reconnectMode ? (l.default.debug("Try next gateway"), Y.socket.connectNext()) : "recover" === Y.reconnectMode && (l.default.debug("Recover gateway"), l.default.debug("Try to reconnect choose server and get gateway list again "), (0, v.getGatewayList)(Y.joinInfo, function (e) {
                            Y.socket.replaceHost(e.gateway_addr)
                        })) : (te(e.gatewayAddr), Y.socket.on("onUplinkStats", function (e) {
                            Y.localStreams[Y.uid] && (Y.localStreams[Y.uid].uplinkStats = e)
                        }), Y.socket.on("connect", function () {
                            Y.attemps = 1, ne(b(e), Y.onConnect, n)
                        }), Y.socket.on("recover", function () {
                            Y.state = W, l.default.debug("Try to reconnect choose server and get gateway list again "), (0, v.getGatewayList)(Y.joinInfo, function (e) {
                                Y.socket.replaceHost(e.gateway_addr)
                            })
                            ...
                            if (Y.state !== H) {
                                ...
                                if (Y.dispatchEvent(t), 0 === Y.p2ps.size ? Y.reconnectMode = "tryNext" : Y.reconnectMode = "retry", Z(), 1 != i) {
                                    var n = z(Y.attemps);
                                    l.default.error("Disconnect from server [" + e + "], attempt to recover [#" + Y.attemps + "] after " + n / 1e3 + " seconds");
                                    setTimeout(function () {
                                        Y.attemps++, Y.state = W, ee()
                                    }, n)
                                }
                            }
                        }), Y.socket.on("onAddAudioStream", function (e) {
                            if (l.default.info("Newly added audio stream with uid", e.id), Y.remoteStreamsInChannel.has(e.id) || Y.remoteStreamsInChannel.add(e.id), void 0 === Y.remoteStreams[e.id]) {
                                var t = (0, o.Stream)({
                                    streamID: e.id,
                                    local: !1,
                                    audio: e.audio,
                            ...
                            if (l.default.info("Newly added remote stream with uid" + e.id + "."), Y.remoteStreamsInChannel.has(e.id) || Y.remoteStreamsInChannel.add(e.id), void 0 === Y.remoteStreams[e.id]) {
                                var t = (0, o.Stream)({
                                    streamID: e.id,
                                    local: !1,
                                    audio: e.audio,
                                ...
                                if (void 0 !== n.stream) {
                                    ...
                                    if (t.video = !0, t.enableVideo(), l.default.info("Stream changed: enable video " + e.id), t.isPlaying()) {
                                    ...
                                    Y.remoteStreams[e.id] = t, l.default.info("Stream changed: modify video " + e.id)
                                }
                            }
                            ...
                            Y.dispatchEvent(i), t.close(), void 0 !== t.pc && (t.pc.close(), t.pc = void 0, Y.p2ps.delete(t.p2pId))
                            ...
                            Y.dispatchEvent(t), i = !0, leave()
                        }), Y.socket.on("stream_fallback", function (e) {
                            l.default.info("stream fallback uid:" + e.id + " peerId:" + e.peerid + " type:" + e.type);
                            var t = (0, c.ClientEvent)({
                            ...
                            l.default.info("stream recover uid:" + e.id + "peerId:" + e.peerid + " type:" + e.type);
                            var t = (0, c.ClientEvent)({
                                type: "stream-recover",
                                uid: e.id,
                                stream: e.peerid,
                            ...
                            if (l.default.debug("p2plost:", e, "p2ps:", Y.p2ps), "publish" === e.event) {
                            ...
                            l.default.debug("Received Message onTokenPrivilegeWillExpire"), Y.dispatchEvent((0, c.ClientEvent)({
                                type: "onTokenPrivilegeWillExpire"
                            }))
                        }), Y.socket.on("onTokenPrivilegeDidExpire", function () {
                            l.default.warning("Received Message onTokenPrivilegeDidExpire, please get new token and join again"), Y.dispatchEvent((0, c.ClientEvent)({
                            ...
                            if (l.default.debug("Receive notification: ", e), "ERR_JOIN_BY_MULTI_IP" === p.GatewayErrorCode[e.code]) return Y.dispatchEvent({
                                type: "onMultiIP",
                                arg: e
                            });
                            e.detail ? Y._doWithAction(R.default[p.GatewayErrorCode[e.code]]) : e.action && Y._doWithAction(e.action)
                            ...
                            if (Y.remoteStreamsInChannel.has(e.id) && Y.remoteStreamsInChannel.delete(e.id), Y.remoteStreams.hasOwnProperty(e.id) && (t.stream = Y.remoteStreams[e.id]), Y.dispatchEvent(t), Y.remoteStreams.hasOwnProperty(e.id)) {
                                ...
                                i.close(), delete Y.remoteStreams[e.id], void 0 !== i.pc && (i.pc.close(), i.pc = void 0, Y.p2ps.delete(i.p2pId))
                            }
                            Y.timers.hasOwnProperty(e.id) && (clearInterval(Y.timers[e.id]), clearInterval(Y.timers[e.id] + "_RelatedStats"), delete Y.timers[e.id]), void 0 != Y.audioLevel[e.id] && delete Y.audioLevel[e.id], void 0 != Y.timer_counter[e.id] && delete Y.timer_counter[e.id]
                    ...
                    ne = function (e, t, i) {
                        if (void 0 === Y.socket) return l.default.error("No socket available"), void J(i, f.default.INVALID_OPERATION);
                        try {
                            Y.socket.emitSimpleMessage(e, function (e, n) {
                                "success" === e ? "function" == typeof t && t(n) : "function" == typeof i && i(p.GatewayErrorCode[n] || n)
                            })
                        } catch (t) {
                            l.default.error("Socket emit message failed" + JSON.stringify(e)), l.default.error(t), J(i, f.default.SOCKET_ERROR)
                        }
                    },
                    re = function (e, t) {
                        if (void 0 === Y.socket) return void l.default.error("Error in sendSimpleSdp [socket not ready]");
                        try {
                    ...
                    ae = function () {
                        ...
                        for (var e in Y.remoteStreams)
                            if (Y.remoteStreams.hasOwnProperty(e)) {
                                var t = Y.remoteStreams[e];
                                t.stop(), t.close(), delete Y.remoteStreams[e], void 0 !== t.pc && (t.pc.close(), t.pc = void 0)
                            }
                    };
                return Y
            },
            y = {
                ...
                register: function (e, t) {
                    ...
                    if (t.cname) {
                        ...
                        return l.default.debug("register client Channel", t.cname, "Uid", t.uid), i._gatewayClients[t.cname] || (i._gatewayClients[t.cname] = {}), i._gatewayClients[t.cname][t.uid] = e, null
                    }
                ...
                unregister: function (e) {
                    ...
                    if (t._gatewayClients[n] && t._gatewayClients[n][i]) {
                        ...
                        return l.default.debug("unregister client ", e.uid), delete t._gatewayClients[n][i], null
                    }
                    var r = "GATEWEAY_CLIENT_UNREGISTERED";
                    l.default.error(r)
                }
            };
        b.DISCONNECTED = 0, b.CONNECTING = 1, b.CONNECTED = 2, b.DISCONNECTING = 3, t.default = b
    }, function (e, t, i) {
        "use strict";
        Object.defineProperty(t, "__esModule", {
            value: !0
        ...
        var n = i(33),
            ...
            a = function (e, t) {
                ...
                return i.connect = function () {
                    t.host = e, i.signal = (0, r.default)(t), i.on = i.signal.on, i.dispatchEvent = i.signal.dispatchEvent, i.signal.on("onopen", function (e) {
            ...
            u = function (e) {
                ...
                return t.needReconnect = !0, t.isTimeout = !1, t.isInit = !0, t.hostIndex = 0, t.requestID = 0, e.host instanceof Array ? t.host = e.host : t.host = [e.host], t.getURL = function () {
                    ...
                    d.default.debug("start connect:" + t.host[t.hostIndex]), t.lts = (new Date).getTime(), t.connection = new WebSocket("wss://" + t.host[t.hostIndex]), t.connection.onopen = function (e) {
                        d.default.debug("websockect opened: " + t.host[t.hostIndex]), t.needReconnect = !0, t.isTimeout = !1, t.isInit = !1, clearTimeout(t.timeoutCheck), t.dispatchEvent((0, r.MediaEvent)({
                            type: "onopen",
                            event: e,
                            socket: t
                        }))
                        ...
                        t.needReconnect ? t.isTimeout || t.isInit ? (d.default.debug("websockect connect timeout"), c.report.joinGateway(e.sid, {
                            ...
                            type: "disconnect",
                            event: i
                        })) : (d.default.debug("websockect closeed"), (0, a.default)(e.onFailure, i), clearTimeout(t.timeoutCheck), t.dispatchEvent((0, r.MediaEvent)({
                            type: "close",
                            event: i
