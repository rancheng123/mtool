/*! AgoraRTC|BUILD v2.5.2-0-g6901399 */
        ...
        var ue = function () {
            ...
            Ve = function (e, t) {
                Me(function (i, n) {
                    ...
                    ! function (e, t) {
                        /**
                         * sdk2.5与sdk2.0老版本功能不一致，新版本分享有选窗口功能， 老版本没有这个功能，所以注释掉
                         * 此处只是注释和 添加 t && t(null, e[0].id) 如需回复 去掉 t && t(null, e[0].id) 和注释即可
                         * @time 2018/8/29
                         * @author shijh
                         */
                        t && t(null, e[0].id)
                    ...
                    if (He(e, "profile", ["480p_1", "480p_2", "720p_1", "720p_2", "1080p_1", "1080p_2"]), "string" == typeof e && t.screen) {
                        switch (e) {
                            ...
                            case "1080p_1":
                                 ...
                                 */
                                t.screenAttributes.width = 1920, t.screenAttributes.height = 1080, t.screenAttributes.maxFr = 10, t.screenAttributes.minFr = 1;
                                break;
                            case "1080p_2":
